...
i18next
    ...
    .init({
        ...
        load: 'languageOnly',
        ns: ['common', 'main', 'labels', 'buttons', 'serviceRequestStatus', 'configurationItemStatus'], // string or array of namespaces to load
        defaultNS: 'common',  // default namespace used
        fallbackLng: 'en', // language to use if translations in user language are not available
        whitelist: ['en', 'lt'], // array of allowed languages
